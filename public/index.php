...
$router->add('GET', '/admin/orders/(\d+)', [new OrdersController(), 'show']);
$router->add('POST', '/admin/orders/(\d+)/status', [new OrdersController(), 'updateStatus']);
$router->add('POST', '/admin/orders/(\d+)/resend', [new OrdersController(), 'resend']);
